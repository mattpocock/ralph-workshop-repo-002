...
The core innovation of npx agent-browser: compact element references that reduce context usage dramatically for AI agents.
...
npx agent-browser uses compact snapshots with refs:
