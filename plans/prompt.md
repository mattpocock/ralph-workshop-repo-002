...
- Check that the feature works using the Playwright MCP server to test the dev server. It will be running on `localhost:3000` (or `http://host.docker.internal:3000`) - no need to start it yourself.
